...
[ -f configs/config_rk3328 ] && sed -i '/CONFIG_KERNEL_CGROUP_PERF/i\CONFIG_KERNEL_CGROUPS=y' friendlywrt/target/linux/rockchip-rk3328/config-4.14
...
[ -f configs/config_h5 ] &&     sed -i '/CONFIG_KERNEL_CGROUP_PERF/i\CONFIG_KERNEL_CGROUPS=y' friendlywrt/target/linux/allwinner-h5/config-4.14
...
[ -f configs/config_h3 ] &&     sed -i '/CONFIG_KERNEL_CGROUP_PERF/i\CONFIG_KERNEL_CGROUPS=y' friendlywrt/target/linux/allwinner-h5/config-4.14
